...
public class MyBot_v7_deltaPruning : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        // Iterative Deepening
        // TIME MANAGEMENT
        // "remaining_time/N" where N is some constant, with Min(x, 1000)
        // usually N is predicted moves the game will last 
        // var timeToThink = timer.MillisecondsRemaining / 40;
        // "remaining_time/N" where N is progressive with the game
        // if N is legalMoves.Length, then 1 <= N <= 256
        // if N is (constant - board.PlyCount), but (early) 40 => N => 15 (endgame)
