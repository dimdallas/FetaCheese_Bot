...
public class MyBot_v5_noEarlyDepthBound_1099Tokens : IChessBot
{
    ...
    int MopUpEvaluation(bool whiteAdvantage, Board board)
    {
        ...
        var trapEvaluation =/*4.7f * #1#CenterManhattanDistance(opponentKingSquare)
                                       + /*1.6f * #1#(14 - Math.Abs(myKingSquare.File - opponentKingSquare.File) - Math.Abs(myKingSquare.Rank - opponentKingSquare.Rank));*/
